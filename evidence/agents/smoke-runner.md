...
| --- | --- | --- | --- |
| "environment-class defects are found by executing, never by reading a diff" | defects that reached no reviewer and only executing found: PHP extension build failures, nginx body-size 413s, compose-isolation collisions in CI, flaky e2e locators | 2026-08-21 (recorded; undated) | - |
